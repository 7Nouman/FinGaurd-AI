...
const ResultCard = ({ result }) => {
  ...
  const badgeByRisk = (risk) => {
    if (risk === 'High') return { text: 'High Risk', cls: 'bg-[#2a0e12] text-red-300 border-red-800/40' };
    if (risk === 'Medium') return { text: 'Medium Risk', cls: 'bg-[#231b0e] text-yellow-300 border-yellow-800/40' };
    return { text: 'Low Risk', cls: 'bg-[#0f2117] text-green-300 border-green-800/40' };
  };
